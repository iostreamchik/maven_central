...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jreleaser</b> with value <b>1.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJreleaser() { return getVersion("jreleaser"); }
    ...
    public static class MavenVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>maven.publish</b> with value <b>0.30.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>jreleaser</b> with plugin id <b>org.jreleaser</b> and
         * with version reference <b>jreleaser</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getJreleaser() { return createPlugin("jreleaser"); }

        /**
         * Plugin provider for <b>signing</b> with plugin id <b>org.gradle.signing</b> and
         * with <b>no version specified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSigning() { return createPlugin("signing"); }
    ...
    public static class MavenPluginAccessors extends PluginFactory {
        private final MavenPublishPluginAccessors paccForMavenPublishPluginAccessors = new MavenPublishPluginAccessors(providers, config);

        public MavenPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.maven.publish</b>
         */
        public MavenPublishPluginAccessors getPublish() {
            return paccForMavenPublishPluginAccessors;
        }

    }

    public static class MavenPublishPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
         ...
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("maven.publish"); }

        /**
         * Plugin provider for <b>maven.publish.plugin</b> with plugin id <b>com.vanniktech.maven.publish</b> and
